      ...
      >
        <div className="grid grid-rows-2 gap-5">
          <div className="grid grid-cols-2">
            <div
              className="bg-white w-60 h-60 lg:translate-y-20 
            ...
            <div
              className=" w-60 h-60 bg-white lg:-translate-x-27 
                        shadow-[0_10px_30px_rgba(0,0,0,0.7)]
                        flex flex-col items-center justify-center rounded-lg"
            >
          ...
          <div className="grid grid-cols-2 lg:pl-[255px] pb-10">
            <div
              className="w-60 h-60 bg-white lg:translate-x-1 lg:-translate-y-7
                        shadow-[0_10px_30px_rgba(0,0,0,0.7)]
                        flex flex-col items-center justify-center rounded-lg"
            >
            ...
            <div
              className="w-60 h-60 bg-white lg:-translate-y-20 lg:translate-x-6 
                        shadow-[0_10px_30px_rgba(0,0,0,0.7)]
                        flex flex-col items-center justify-center rounded-lg"
            >
