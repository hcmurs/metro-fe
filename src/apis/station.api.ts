...
export const apiCreateStation = async (station: StationRequest): Promise<ApiResponse<Station> | null> => {
  try {
...
export const apiGetStationById = async (stationId: number): Promise<ApiResponse<Station> | null> => {
    try {
  ...
  export const apiGetStationByName = async (stationName: string): Promise<ApiResponse<Station[]> | null> => {
    try {
  ...
  export const apiUpdateStation = async (station: Station, id: number): Promise<ApiResponse<Station> | null> => {
    try {
  ...
  export const apiDeleteStation = async (id: number): Promise<ApiResponse<Station> | null> => {
    try {
