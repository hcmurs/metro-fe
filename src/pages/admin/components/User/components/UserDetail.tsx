          ...
          <div className="flex w-full gap-2 items-center">
            ...
            {user.status === "active" ? (
              <div className="w-2/14 text-black flex items-center gap-2">
                <Circle className="fill-green-500 text-green-500 flex size-[10px]" />{" "}
                Active
              </div>
            ) : (
              <div className="w-2/14 text-black flex items-center gap-2">
                <Circle className="fill-red-500 text-red-500 flex size-[10px]" />{" "}
                Banned
              </div>
            )}
            <div className="w-3/14">{user.phone}</div>
            {user.role === "admin" ? (
            ...
            <div className="w-2/14">
              <button className="bg-blue-500 text-white px-3 py-1 rounded cursor-pointer hover:bg-blue-400">
                Edit
              </button>
            </div>
          </div>
