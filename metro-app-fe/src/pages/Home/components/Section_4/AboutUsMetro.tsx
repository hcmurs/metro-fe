  ...
  return (
    <div className="w-full h-[700px] flex flex-col lg:flex-row items-center justify-between pb-10 lg:mb-0 mb-10">
      <div className="lg:w-1/2 w-full mb-10 lg:mb-0 bg-[#D4FCEE] h-full flex flex-col justify-center px-30 py-10 items-center lg:rounded-l-2xl lg:rounded-none rounded-2xl">
        <h2 className="text-5xl font-bold text-slate-900 mb-4 text-center">Thông tin về chúng tôi</h2>
        <p className="text-gray-700 text-lg mb-8 max-w-md text-center">
          Bạn đã sẵn sàng quảng cáo với Metro HCMR chưa? <br/> Đưa thương hiệu của bạn đến tương lai của giao thông đô thị.
        </p>
        <div className="flex gap-4">
          <button className="bg-slate-800 text-white px-6 py-2 rounded hover:bg-slate-600">Bắt đầu ngay</button>
          <button className="bg-red-600 text-white px-6 py-2 rounded hover:bg-red-700">Quảng cáo ngay</button>
        </div>
      </div>
